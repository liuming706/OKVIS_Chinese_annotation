...
#
# EIGEN_FOUND - system has eigen lib with correct version EIGEN_INCLUDE_DIR -
# the eigen include directory EIGEN_VERSION - eigen version
...
if(NOT Eigen_FIND_VERSION)
  ...
  set(Eigen_FIND_VERSION
      "${Eigen_FIND_VERSION_MAJOR}.${Eigen_FIND_VERSION_MINOR}.${Eigen_FIND_VERSION_PATCH}"
  )
...
macro(_eigen3_check_version)
  ...
  if(NOT EIGEN_VERSION_OK)
    ...
    message(
      STATUS "Eigen version ${EIGEN_VERSION} found in ${EIGEN_INCLUDE_DIR}, "
...
if(EIGEN_INCLUDE_DIRS)
  ...
  set(EIGEN_INCLUDE_DIRS
      ${EIGEN_INCLUDE_DIR}
      CACHE PATH "The Eigen include path.")
